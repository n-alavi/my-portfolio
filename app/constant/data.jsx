...
export const services = [
  {
    icon: <FaGlobe className="text-5xl text-pink-500" />,
    name: "Personal Website Development",
    description:
      "Building fully customized websites using modern technologies with guaranteed performance, security, and a unique user experience.",
  },
  {
    icon: <FaMobileAlt className="text-5xl text-pink-500" />,
    name: "Responsive Web Design",
    description:
      "Creating optimized and responsive user experiences so your website looks great on all devices and screen sizes.",
  },
  {
    icon: <FaBolt className="text-5xl text-pink-500" />,
    name: "Single-Page Applications (SPA)",
    description:
      "Developing fast, dynamic, and scalable single-page applications with React and Next.js, including state management and API interactions.",
  },
  {
    icon: <FaPaintBrush className="text-5xl text-pink-500" />,
    name: "UI/UX Design",
    description:
      "Implementing user-friendly and accessible designs to ensure excellent usability and a polished interface.",
  },
  {
    icon: <FaRocket className="text-5xl text-pink-500" />,
    name: "Website & Performance Optimization",
    description:
      "Improving website speed, SEO, and overall performance using advanced front-end and back-end optimization techniques.",
  },
  {
    icon: <FaLink className="text-5xl text-pink-500" />,
    name: "API Development & Integration",
    description:
      "Designing, developing, and integrating RESTful APIs and third-party services to deliver dynamic content and data management using PostgreSQL and Prisma.",
  },
  {
    icon: <FaBolt className="text-5xl text-pink-500" />,
    name: "Back-End Development & Security",
    description:
      "Working with Elysia and Bun for server-side development, database management, authentication, security, and scalable architecture.",
  },
];
...
<path fillRule="evenodd" clip-rule="evenodd" d="M424.404 470.816C478.089 423.889 512 354.905 512 278C512 136.615 397.385 22 256 22C114.615 22 0 136.615 0 278C0 352.658 31.9583 419.851 82.9409 466.646L83.1767 465L419.144 355L424.404 470.816Z" fill="#333333"/>
...
<path d="M212.749 278.858L212.267 279.133C199.686 286.322 192.918 299.892 193.58 314.367C193.768 318.484 197.893 322.255 201.858 321.132L209.163 319.062C218.607 316.386 227.353 311.681 234.789 305.274L256 287L262.292 282.343C298.871 255.269 344.833 244.113 389.754 251.405C391.14 251.63 391.184 253.607 389.81 253.894L384.5 255L382.093 255.842C377.15 257.572 372.856 260.776 369.79 265.022C369.214 265.819 369.982 266.89 370.922 266.601L372.663 266.065C382.467 263.049 392.751 261.904 402.978 262.691L407 263C428.843 263.95 449.114 274.626 462.254 292.1L467.179 298.65C481.776 318.063 487.953 342.53 484.319 366.545L482.421 379.087C479.837 396.163 473.618 412.486 464.184 426.952L463.5 428L453 442L441.5 455L430.965 465.114C421.346 474.348 410.827 482.597 399.567 489.738L396 492L389.175 495.25C387.417 496.087 385.95 493.678 387.5 492.5L397 483.5L398.953 481.449C404.232 475.906 408.027 469.12 409.986 461.721L410.889 458.309C411.295 456.776 411.5 455.174 411.5 453.588C411.5 444.909 405.354 437.298 396.836 435.631C391.554 434.597 386.085 435.962 381.907 439.356L372.5 447L355.894 460.587C344.995 469.504 333.185 477.245 320.66 483.682L303.5 492.5L274.5 503.5L268.412 505.16C257.822 508.049 247.012 510.06 236.092 511.174L228 512H202L167.5 508.25L148.832 504.21C138.985 502.079 129.456 498.682 120.482 494.103C113.181 490.378 106.293 485.894 99.931 480.725L85.5 469C68.005 455.64 57.0449 435.448 55.3749 413.498L54.5 402L55.5295 385.822C57.134 360.608 66.7911 336.576 83.0792 317.263C89.6652 309.454 97.2376 302.534 105.606 296.675L108.677 294.526C121.458 285.579 135.72 278.961 150.805 274.976L160.947 272.297C174.135 268.813 187.952 268.445 201.307 271.22L211.887 273.418C214.542 273.97 215.103 277.513 212.749 278.858Z" fill="#5E5E5E"/>
    ...
    description: "High-performance backend framework built on Bun, focused on speed and developer experience.",
  },
  {
    name: "PostgreSQL",
    icon: <SiPostgresql className="text-sky-700 text-4xl" />,
    description: "Advanced relational database known for reliability and SQL standard compliance.",
  },
  {
    name: "Prisma ORM",
    icon: <SiPrisma className="text-cyan-600 text-4xl" />,
    description: "Modern TypeScript ORM simplifying database access with type-safe queries and schema management.",
  },
  {
    name: "Bun Runtime",
    icon: <SiBun className="text-gray-800 text-4xl" />,
    description: "Next-generation JavaScript runtime optimized for speed, bundling, and native ESM support.",
  },
   {
    name: "MongoDB",
    icon: <SiMongodb className="text-green-600 text-4xl" />,
    description: "NoSQL database enabling flexible document-based data modeling for scalable applications.",
  },
];
...
export const projects = [
  ...
  },
  {
    ...
    description: 
`
Comprehensive multi-panel platform with bilingual interface (Danish & English), enabling users to manage subscriptions and vouchers, stores to handle dashboards, pages, vouchers, Stripe payments, analytics, and admins to oversee users, stores, transactions, and platform performance.
`,
